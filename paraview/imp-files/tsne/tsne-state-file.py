...
lineChartView1.ViewSize = [720, 375]
lineChartView1.LegendPosition = [519, 298]
lineChartView1.LeftAxisUseCustomRange = 1
lineChartView1.LeftAxisRangeMinimum = -1322.3501327622744
lineChartView1.LeftAxisRangeMaximum = 1517.4720838654848
lineChartView1.BottomAxisUseCustomRange = 1
lineChartView1.BottomAxisRangeMinimum = -595.6195732052095
lineChartView1.BottomAxisRangeMaximum = 682.3004242772824
lineChartView1.RightAxisUseCustomRange = 1
lineChartView1.RightAxisRangeMinimum = -43.95303990685221
lineChartView1.RightAxisRangeMaximum = 50.61303990685221
lineChartView1.TopAxisUseCustomRange = 1
lineChartView1.TopAxisRangeMinimum = -43.95303990685221
lineChartView1.TopAxisRangeMaximum = 50.61303990685221
...
renderView2.ViewSize = [720, 375]
renderView2.AxesGrid = 'GridAxes3DActor'
renderView2.CenterOfRotation = [-1.1507500000000022, 0.9924999999999926, 0.0]
renderView2.StereoType = 'Crystal Eyes'
renderView2.CameraPosition = [305.353587489826, 307.49683748982596, 306.50433748982607]
renderView2.CameraFocalPoint = [-1.1507500000000022, 0.9924999999999926, 0.0]
renderView2.CameraViewUp = [-0.4082482904638631, 0.816496580927726, -0.40824829046386296]
renderView2.CameraFocalDisk = 1.0
renderView2.CameraParallelScale = 137.40213555324857
...
renderView3.ViewSize = [720, 375]
renderView3.AxesGrid = 'GridAxes3DActor'
renderView3.CenterOfRotation = [-1.1507500000000022, 0.9924999999999926, 0.0]
renderView3.StereoType = 'Crystal Eyes'
renderView3.CameraPosition = [194.37804406813677, 239.9495204334282, 431.859652868926]
renderView3.CameraFocalPoint = [-1.1507500000000026, 0.9924999999999925, -2.9141348567661566e-16]
renderView3.CameraViewUp = [-0.228194732067029, 0.8919874054330769, -0.39023791820583587]
renderView3.CameraFocalDisk = 1.0
renderView3.CameraParallelScale = 137.40213555324857
...
morsesmalletsneaccuratecsv = CSVReader(registrationName='morse-smalle-tsne-accurate - Copy.csv', FileName=['G:\\My Drive\\UALR\\GA\\GA\\Repository\\paraview\\All\\t-sne\\accurate\\morse-smalle-tsne-accurate - Copy.csv'])

# create a new 'Table To Points'
tableToPoints1 = TableToPoints(registrationName='TableToPoints1', Input=morsesmalletsneaccuratecsv)
tableToPoints1.XColumn = 'TSNE-0'
tableToPoints1.YColumn = 'TSNE-1'
tableToPoints1.ZColumn = 'TSNE-0'
...
threshold1.LowerThreshold = 1.8474252216636098
...
ascendingManifoldLUT.RGBPoints = [-1.0, 0.231373, 0.298039, 0.752941, 80.5, 0.865003, 0.865003, 0.865003, 162.0, 0.705882, 0.0156863, 0.14902]
...
ascendingManifoldPWF.Points = [-1.0, 0.0, 0.5, 0.0, 162.0, 1.0, 0.5, 0.0]
...
ascendingManifoldLUTColorBar.WindowLocation = 'Any Location'
ascendingManifoldLUTColorBar.Position = [0.8317107093184979, 0.05758426966292135]
ascendingManifoldLUTColorBar.Title = 'AscendingManifold'
ascendingManifoldLUTColorBar.ComponentTitle = ''
ascendingManifoldLUTColorBar.ScalarBarLength = 0.8777528089887647
...
SetActiveSource(morsesmalletsneaccuratecsv)
# ----------------------------------------------------------------
