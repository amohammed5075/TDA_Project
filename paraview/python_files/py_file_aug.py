...
lineChartView1.ViewSize = [247, 367]
...
renderView3.ViewSize = [1016, 786]
renderView3.AxesGrid = 'GridAxes3DActor'
renderView3.CenterOfRotation = [2.8439835, 3.342089999999999, 0.0]
renderView3.StereoType = 'Crystal Eyes'
renderView3.CameraPosition = [25.624792049175298, -5.37779534623602, 101.69684119615128]
renderView3.CameraFocalPoint = [2.8439834999999998, 3.3420899999999985, 3.897390825201506e-18]
renderView3.CameraViewUp = [0.01709697702418566, 0.9965172413084695, 0.08161544677076717]
...
layout1.AssignView(7, lineChartView1)
layout1.AssignView(8, spreadSheetView1)
...
gaussianResampling3.GaussianSplatRadius = 0.01
...
# create a new 'Table To Points'
tableToPoints2 = TableToPoints(registrationName='TableToPoints2', Input=new_pointscsv)
tableToPoints2.XColumn = 'UMAP-0'
tableToPoints2.YColumn = 'UMAP-1'
tableToPoints2.ZColumn = 'Battery Life'
...
ascendingManifoldLUT.RGBPoints = [-1.0, 0.231373, 0.298039, 0.752941, 346.0, 0.865003, 0.865003, 0.865003, 693.0, 0.705882, 0.0156863, 0.14902]
...
ascendingManifoldPWF.Points = [-1.0, 0.0, 0.5, 0.0, 693.0, 1.0, 0.5, 0.0]
...
tableToPoints2Display.PointSize = 5.0
...
tableToPoints2Display.OSPRayScaleArray = 'Beach Name'
tableToPoints2Display.OSPRayScaleFunction = 'PiecewiseFunction'
tableToPoints2Display.SelectOrientationVectors = 'None'
tableToPoints2Display.ScaleFactor = 0.3004163777
tableToPoints2Display.SelectScaleArray = 'Beach Name'
tableToPoints2Display.GlyphType = 'Arrow'
tableToPoints2Display.GlyphTableIndexArray = 'Beach Name'
tableToPoints2Display.GaussianRadius = 0.015020818885
tableToPoints2Display.SetScaleArray = ['POINTS', 'Beach Name']
tableToPoints2Display.ScaleTransferFunction = 'PiecewiseFunction'
tableToPoints2Display.OpacityArray = ['POINTS', 'Beach Name']
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
tableToPoints2Display.ScaleTransferFunction.Points = [2.0, 0.0, 0.5, 0.0, 5.0, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
tableToPoints2Display.OpacityTransferFunction.Points = [2.0, 0.0, 0.5, 0.0, 5.0, 1.0, 0.5, 0.0]
...
# show data from tableToPoints2
tableToPoints2Display_1 = Show(tableToPoints2, spreadSheetView1, 'SpreadSheetRepresentation')

# trace defaults for the display properties.
tableToPoints2Display_1.Assembly = ''
...
SetActiveSource(gaussianResampling3)
# ----------------------------------------------------------------
